  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved discussion as @discussion" do
        ...
        post :create, {:discussion => { "course_id" => "invalid value" }}, valid_session
        assigns(:discussion).should be_a_new(Discussion)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested discussion" do
        ...
        Discussion.any_instance.should_receive(:update).with({ "course_id" => "1" })
        put :update, {:id => discussion.to_param, :discussion => { "course_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the discussion as @discussion" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Discussion.any_instance.stub(:save).and_return(false)
        put :update, {:id => discussion.to_param, :discussion => { "course_id" => "invalid value" }}, valid_session
        assigns(:discussion).should eq(discussion)
      end
